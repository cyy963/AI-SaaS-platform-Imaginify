...
```bash
git clone https://github.com/adrianhajdin/imaginify.git](https://github.com/cyy963/AI-SaaS-platform-Imaginify/tree/development
cd ai-saas-platform-imaginify
```
